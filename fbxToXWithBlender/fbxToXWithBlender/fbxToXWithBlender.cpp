// fbxToXWithBlender.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//

#include "stdafx.h"
#include "fbxToXWithBlender.h"
...
INT WINAPI wWinMain( HINSTANCE hInst, HINSTANCE, LPWSTR, INT )
{
	...
	HWND hWnd = CreateWindow( L"D3D Tutorial", L"FBX to X file", WS_OVERLAPPEDWINDOW, 100, 100, 600, 600, NULL, NULL, wc.hInstance, NULL );
